...
if(!empty($_POST)){
    ...
    if(isset($_POST['GoSignUp'])) {
        ...
        if($ok) {
            ...
            header("Location: okSended.php?type=".$_POST['GoSignIn']);
            exit;
        } else {
            echo "ERROR";
        }
...
<html lang="fr">
    ...
    <body onload="check()"> 
        ...
        <div class="container <?php if(!isset($okVeutSeConnecter)){ ?> right-panel-active <?php } ?>" id="container">
            <div class="form-container sign-up-container">
                <form action="" method="post">
                    ...
                    <span id="error-iemail" class="error"><?php if(isset($err_email)) echo $err_email?></span>
                    ...
                    <span id="error-ipassword" class="error"><?php if(isset($err_password)) echo $err_password?></span>
            ...
            <div class="form-container sign-in-container">
                <form action="">
                    ...
                    <input onkeyup="check()" type="email" name="email" id="cemail" placeholder="Email" />
                    <span id="error-cemail" class="error"></span>

                    <input onkeyup="check()" type="password" name="password" id="cpassword"  placeholder="Mot de passe" />
        ...
        <script>
            ...
            var okMailExisteDeja = <?php if(isset($okDejaMailExiste)){ echo $okDejaMailExiste;} {echo "0";}  ?>;
